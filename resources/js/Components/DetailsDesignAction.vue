...
<template>
   <div class="bg-gray-100 shadow-lg">
      <swiper  :modules="[Navigation, Pagination, Scrollbar, A11y]"
               :slides-per-view="3"
               :space-between="40"
               :breakpoints="{ 1536:{ slidesPerView:3}, 1024:{ slidesPerView:2}, 0:{ slidesPerView:1} }"
         ...
         <div class="swiper-pagination-custom flex items-center justify-center py-2"></div>
               <swiper-slide class="sm:h-48 h-58" v-for="(design, key) in designs" :key="key">
            <div class=" bg-gray-200 grid grid-cols-12 px-4 py-4 " >
               <div class="2xl:col-span-4 lg:col-span-3 sm:col-span-2 xsm:col-span-4 col-span-5  flex items-stretch justify-center  w-full">
               ...
               <div class="2xl:col-span-8 lg:col-span-9 sm:col-span-10 xsm:col-span-8 col-span-7 px-2 grid grid-cols-1">
