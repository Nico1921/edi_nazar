   ...
   <section class="container mx-auto mt-5">
      ...
      <div class="grid grid-cols-4">
                  ...
                  <div class="sm:col-span-10 xsm:col-span-9 col-span-8 flex flex-col xl:text-lg text-sm">
                     ...
                     <div class="grid grid-cols-8">               
                        <div class="xl:col-span-5 col-span-4 w-full h-8 bg-gray-300 flex items-center justify-center rounded">
                           <form v-if="produit.stats_produit.stock_restant > 0" class="editQteForm w-full h-full">
                              ...
                              <input type="hidden" name="id_panier_edi"
                                 :value="(props.panier.id_panier_edi != undefined ? props.panier.id_panier_edi : 0)" />
                        ...
                        <div class="xl:col-span-3 col-span-4 sm:mx-4 mx-2">
                           <button type="button"
                              @click="deleteCommande((produit.panier.id_panier_edi_list != undefined ? produit.panier.id_panier_edi_list : 0),(props.panier.id_panier_edi != undefined ? props.panier.id_panier_edi : 0),key)"
         ...
         <div class="lg:hidden block col-span-4">
            <ResumeOrderVertical :linkEtapeSuivant="'/cart/adresses'" :titreLink="'Valider la commande'" :panier="props.panier" :isButtonSubmit="false" />
         </div>
         <div class="lg:block hidden col-span-1 ml-5">
            <ResumeOrder :linkEtapeSuivant="'/cart/adresses'" :titreLink="'Valider la commande'" :panier="props.panier" :isButtonSubmit="false" />
         </div>
      </div>
   </section>
</template>