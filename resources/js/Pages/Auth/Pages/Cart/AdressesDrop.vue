      ...
      <div class="grid grid-cols-4">
         ...
         <div class="col-span-4 grid grid-cols-4 xl:mx-16 ">
            <div class="lg:col-span-3 col-span-4 ">
               ...
               <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8 ">
                  <div v-for="(client, key) in clients" :key="key"
                     class="bg-white rounded-lg shadow-lg p-6 flex flex-col justify-between hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
                     <div class="flex flex-row justify-between items-center">
                        <div class="flex flex-row items-center">
                           <Tooltip :placement="'top'" :triggers="['hover', 'focus', 'click']">
                              <div>
                           ...
                           <div>
                              <span class="text-lg"><span class="font-bold">Commande : </span>{{ client.client.ref_externe
                              }}</span>
                              <div class="flex flex-col"
                                 v-if="client.client.adresse1 != '' && client.client.adresse1 != null">
                                 <span class="text-lg"><span class="font-bold">Adresse commande : </span>{{
                                    client.client.nom_adresse }},</span>
                                 <span class="text-lg">{{ client.client.adresse1 }},</span>
                                 <span v-if="client.client.adresse2 != '' && client.client.adresse2 != null"
                                    class="text-lg ">{{ client.client.adresse2 }},</span>
                                 <span v-if="client.client.adresse3 != '' && client.client.adresse3 != null"
                                    class="text-lg ">{{ client.client.adresse3 }},</span>
                        ...
                        <div class="">
                           <button @click="openModal(client.client.ref_externe, client.client)"
            ...
            <div class="lg:hidden block col-span-4">
               <ResumeOrderVertical :disabled="!allValid"
                  :linkEtapeSuivant="(panierDrop.panier.addresses_valid ? '/dropshipping/cart/validation' : '')"
                  :titreLink="'Valider mon adresse'"
                  :panier="(panierDrop.panier.panierActuel != undefined ? panierDrop.panier.panierActuel : undefined)"
                  :isButtonSubmit="false" />
            </div>
            <div class="lg:block hidden col-span-1 ml-5 ">
               <ResumeOrder :disabled="!allValid"
                  :linkEtapeSuivant="(panierDrop.panier.addresses_valid ? '/dropshipping/cart/validation' : '')"
                  :titreLink="'Valider mon adresse'"
                  :panier="(panierDrop.panier.panierActuel != undefined ? panierDrop.panier.panierActuel : undefined)"
                  :isButtonSubmit="false" />
