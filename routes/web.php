...
Route::get('/cookies', function () {return Inertia::render('Auth/Pages/Legales/Cookies');})->name('cookies');
...
Route::middleware(['auth', 'verified','typeVente'])->group(function () {
   ...
   Route::middleware(['type-entrepot'])->group(function () {
      ...
      Route::get('/cart/error/{error}', [CartController::class, 'create'])->name('cart/error/{error}');
